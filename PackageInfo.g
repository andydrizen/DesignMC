#############################################################################
##  
##  PackageInfo.g for the package `DesignMC'                     A. L. Drizen
##                                                               

SetPackageInfo( rec(

##  This is case sensitive, use your preferred spelling.
PackageName := "DesignMC",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "Generate Uniformly Distributed Random 2-Designs with Block Size 3",
...
ArchiveURL := "http://www.maths.qmul.ac.uk/~ald/DesignMC/DesignMC",
...
#
README_URL:="http://www.maths.qmul.ac.uk/~ald/DesignMC/README",
PackageInfoURL:="http://www.maths.qmul.ac.uk/~ald/DesignMC/PackageInfo.g",
...
# utilities.",
AbstractHTML := 
  "The <span class=\"pkgname\">DesignMC</span> package, is an extension \
...
PackageWWWHome := "http://www.maths.qmul.ac.uk/~ald/DesignMC",
...
AvailabilityTest := function()
  local path,file;
    ...
    if file=fail then
      Info(InfoWarning,1,
        "Package ``DesignMC'': The program `hello' is not compiled");
      Info(InfoWarning,1,
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  DesignMC ", ~.Version, "\n",
  "by ", ~.Persons[1].FirstNames, " ", ~.Persons[1].LastName,
        " (", ~.Persons[1].WWWHome, ")\n",
  "For help, type: ?DesignMC package \n",
  "----------------------------------------------------------------\n" ),
