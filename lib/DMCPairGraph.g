...
# forward declaration
FindAllAlternatingTrails:=function();end;

BindGlobal("FindAllAlternatingTrails", function(ImpD, startingPoint, endingPoint, startingColour, otherColour, bannedEdgesList, depth)
...
BindGlobal("SamePairGraphs", function(B1, B2)
	local i,g1,g2, g1_list, g2_list;
...
BindGlobal("FindNonIsoDesignsWithIsoGraphUsingList", function( list )
	local i,D1, D2, numberScanned;

	numberScanned:=0;
	for i in Combinations(list,2) do
